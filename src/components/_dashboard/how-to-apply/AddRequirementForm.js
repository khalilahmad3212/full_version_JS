...
export default function AddRequirementForm({ data, isEdit, limit }) {
                    ...
                    <div key={index}>
                      <Stack direction="column" gap={2} justifyContent="flex-end" sx={{ position: 'relative' }}>
                        ...
                        <div>
                          ...
                          <QuillEditor
                            id={`apply-requirements-content-${index}`}
                            value={paragraph.description}
                            onChange={(val) =>
                              handleParagraphChange(index, { target: { name: 'description', value: val } })
                            }
                          />
                        </div>
                      </Stack>
