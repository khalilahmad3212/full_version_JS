...
import { deleteOrganization, getOrganizations } from '../../../redux/slices/organization';
// utils
...
export default function OrganizationList() {
  ...
  const { organizations: products } = useSelector((state) => state.organization);
  ...
  const handleDeleteProduct = (publicationId) => {
    dispatch(deleteOrganization(publicationId));
  };
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <OrganizationMoreMenu onDelete={() => handleDeleteProduct(Id)} productName={Id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
