...
import { deleteMyDepartment, getMyDepartments } from '../../../redux/slices/my-department';
// utils
...
export default function DepartmentList() {
  ...
  const { departments: products } = useSelector((state) => state.myDepartment);
  ...
  const handleDeleteProduct = (publicationId) => {
    dispatch(deleteMyDepartment(publicationId));
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Box py={2} textAlign="end">
          <Button
            ...
            to={PATH_DASHBOARD.newDepartment}
              ...
              <Table>
                <TableBody>
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { Id, Name, Category, Logo: Image } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          ...
                          >
                            <ThumbImgStyle alt={Name} src={`http://localhost:5001/department-images/${Image}`} />
                            <Typography variant="subtitle2" noWrap>
                              {Name}
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell style={{ minWidth: 160 }}>{Category}</TableCell>
                        <TableCell align="right">
                          <MyDepartmentMoreMenu onDelete={() => handleDeleteProduct(Id)} productName={Id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
