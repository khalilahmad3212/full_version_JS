...
export default function CampusList() {
  ...
  const getCampusData = async () => {
    try {
      const res = await myAxios.get('/campus');
  ...
  const handleDeleteProduct = (publicationId) => {
    try {
      myAxios.delete(`/campus/${publicationId}`);
      getCampusData();
      enqueueSnackbar('Campus Deleted', { variant: 'success' });
    } catch (error) {
      console.log(error);
    }
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Box py={2} textAlign="end">
          <Button
            ...
            to={`${PATH_DASHBOARD.root}/subcampus/new`}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          ...
                          >
                            <ThumbImgStyle alt={Name} src={`${SERVER}/campus-images/${Image}`} />
                        ...
                        <TableCell align="right">
                          <CommonMoreMenu onDelete={() => handleDeleteProduct(Id)} productName={`${PATH_DASHBOARD.root}/subcampus/${Id}/edit`} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
