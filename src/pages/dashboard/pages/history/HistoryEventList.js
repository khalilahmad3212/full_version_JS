...
import CommonMoreMenu from '../../../../components/_dashboard/home/product-list/CommonMoreMenu';
// ----------------------------------------------------------------------
...
export default function HistoryEventList() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await getValueByKey('HISTORY_EVENTS');
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Box py={2} textAlign="end">
          <Button
            ...
            to={PATH_DASHBOARD.history.newEvent}
                      ...
                      <TableRow hover key={id} tabIndex={-1}>
                        ...
                        <TableCell align="right">
                          <CommonMoreMenu
                            ...
                            productName={`${PATH_DASHBOARD.history.root}/events/${id}/edit`}
                          />
                        </TableCell>
                      </TableRow>
                    );
