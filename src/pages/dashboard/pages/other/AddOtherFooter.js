...
import AddOtherFooterForm from '../../../../components/_dashboard/other/AddOtherFooterForm';
// ----------------------------------------------------------------------
...
export default function AddOtherHeader() {
  ...
  useEffect(() => {
    const res = getValueByKey('PAGE_FOOTER');
    res.then((data) => {
  ...
  return (
    <Page title="Home: Tuition Fee | Sukkur IBA">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs heading="Footer" />
        {data && <AddOtherFooterForm data={data} isEdit={isEdit} />}
      </Container>
    </Page>
  );
}
