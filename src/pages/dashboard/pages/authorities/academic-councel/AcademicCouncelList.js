...
export default function AcademicCouncelList() {
  ...
  const getSyndicateData = async () => {
    const response = await getValueByKey('AUTHORITIES_ACADEMIC_COUNCEL');
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={`${PATH_DASHBOARD.authorities.academicCouncel}/new`}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <CommonMoreMenu onDelete={() => handleDeleteUser(Id)} productName={`${PATH_DASHBOARD.authorities.academicCouncel}/${Id}/edit`} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
