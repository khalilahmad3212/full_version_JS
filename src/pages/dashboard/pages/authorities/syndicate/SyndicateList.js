...
export default function SyndicateList() {
  ...
  const getSyndicateData = async () => {
    const response = await getValueByKey('AUTHORITIES_SYNDICATE');
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={`${PATH_DASHBOARD.authorities.syndicate}/new`}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <CommonMoreMenu onDelete={() => handleDeleteUser(Id)} productName={`${PATH_DASHBOARD.authorities.syndicate}/${Id}/edit`} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
