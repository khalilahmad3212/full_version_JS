...
export default function SliderItemsList() {
  ...
  const { sliders: products } = useSelector((state) => state.slider);
  ...
  const handleDeleteProduct = (productId) => {
    dispatch(deleteSlider(productId));
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Box py={2} textAlign="end">
          <Button
            ...
            to={PATH_DASHBOARD.home.newSliderItem}
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          ...
                          >
                            <ThumbImgStyle alt={Title} src={`http://localhost:5001/slider-images/${Image}`} />
