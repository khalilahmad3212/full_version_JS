...
import HowToApplyMoreMenu from '../../../../components/_dashboard/home/product-list/HowToApplyMoreMenu';
...
export default function HowToApplyItemList() {
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Box py={2} textAlign="end">
          <Button
            ...
            to={PATH_DASHBOARD.home.newHowToApply}
                  ...
                  {products?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1}>
                        ...
                        <TableCell style={{ minWidth: 160 }}>{desc}</TableCell>

                        <TableCell align="right">
                          <HowToApplyMoreMenu onDelete={() => handleDeleteProduct(id)} productName={id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
