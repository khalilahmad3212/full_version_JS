...
import { getUserList2, deleteUser } from '../../redux/slices/user';
// routes
...
export default function UserList2() {
  ...
  const { userList2: userList } = useSelector((state) => state.user);
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu2 onDelete={() => handleDeleteUser(Id)} userName={Id} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
